<template>
  <div>
    ...
    <el-table :data="list">
      ...
      <el-table-column label="名称" prop="hospitalName" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column label="备用联系方式" prop="mobileBk" width="150"></el-table-column>
      <el-table-column label="地区" prop="area" show-overflow-tooltip></el-table-column>
      <el-table-column label="操作" width="160">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="editHospital(scope.row)">编辑</el-button>
          <el-popconfirm title="确定删除吗？" @confirm="deleteHospital(scope.row.hospitalId)" style="margin-left: 10px">
