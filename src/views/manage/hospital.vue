  ...
  <div class="container">
    ...
    <div class="main">
      <div class="flex-between">
        ...
        <el-button type="primary" size="medium" @click="handleModify">修改信息</el-button>
      </div>

      <p class="mt-20 title-block">医院信息：</p>
      <div class="content flex-between">
        <div>
          <span class="title"> 医院简介： </span>
          <el-input type="textarea" autosize v-model="brief" size="small" style="width: 85%"> </el-input><br />
          <span class="title"> 医院地址： </span>
          <el-input v-model="address" size="small" style="width: 85%"></el-input><br />
      ...
      <div class="mt-20 flex-between">
        ...
        <el-button type="primary" size="medium" @click="addVaccine">添加疫苗</el-button>
      </div>
      <el-table :data="list">
    ...
    methods: {
      getInfo() {
        getHospital(this.$store.state.userInfo.hospitalId).then(res => {
          ...
          this.time = [new Date(2000, 1, 1, sTime[0], sTime[1]), new Date(2000, 1, 1, eTime[0], eTime[1])];
