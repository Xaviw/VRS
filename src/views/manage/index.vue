  ...
  <div class="container">
    ...
    <div class="main">
      <div class="flex-between">
        <div>
          <el-input v-model="name" class="w-auto name"></el-input>
          <el-input
            v-model="grade"
            class="w-auto grade"
            size="medium"
...
import { deepClone, money, standardTime } from "util/util";
import Info from "com/info.vue";
import EditVaccine from "com/editVaccine.vue";
import { deleteVaccine } from "../../apis/apis";
