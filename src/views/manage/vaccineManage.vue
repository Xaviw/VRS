<template>
  <div>
    <EditVaccine :visible="editVisible" :data="editData" @close="editVisible = false" @refresh="getList" />
    ...
    <el-table :data="list">
      ...
      <el-table-column label="操作" width="160">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="editVaccine(scope.row)">编辑</el-button>
          <el-popconfirm title="确定删除吗？" @confirm="deleteVaccine(scope.row.vaccineId)" style="margin-left: 10px">
